                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
                    ...
                    >
                        ...
                        <p className="mt-6 text-gray-600 leading-relaxed">
                            We are a team of passionate technologists, designers,
                            and problem-solvers who love turning ideas into reality.
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-6">
                            {checklist.map((item) => (
                                ...
                                >
                                    <div className="h-5 w-5 rounded-full bg-green-50 border border-green-200 flex items-center justify-center text-green-600 flex-shrink-0">
