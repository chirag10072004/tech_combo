    ...
    <div className="min-h-screen bg-white text-slate-900 pt-20">
      ...
      <section className="mx-auto max-w-7xl px-6 py-12 lg:px-8 lg:py-16">
        ...
        <div className="mb-10 flex items-center gap-2 text-sm text-slate-500">
          ...
          <span>›</span>
          <span className="text-slate-700">Cybersecurity Services</span>
        </div>
        ...
        <div className="grid items-center gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <p className="max-w-xl text-lg leading-8 text-slate-600">
              Safeguard your digital assets, cloud systems, and customer data with enterprise-grade threat monitoring, vulnerability assessments, and zero-trust security frameworks.
            </p>
            <div className="mt-8">
              <Link
                to="/contact"
        ...
        <div className="mx-auto flex max-w-7xl flex-col items-center justify-between gap-8 rounded-3xl bg-slate-950 px-8 py-10 text-white md:flex-row md:px-12">
          <div>
            ...
            <p className="mt-3 max-w-xl text-slate-300">
              Contact our cybersecurity experts to assess and fortify your system defenses.
            </p>
          </div>
          <Link
            to="/contact"
