        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-10 items-center">
          ...
          >
            ...
            <p className="
              ...
              max-w-[600px]
            ">
              Build powerful, scalable, and user-friendly mobile applications
              for iOS and Android. From native development to cross-platform
              solutions, we turn your ideas into high-performance digital
